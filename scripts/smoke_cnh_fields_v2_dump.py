...
def main() -> int:
    ...
    for pdf in pdfs:
        ...
        nome_dbg = (((dbg.get("fields_v2") or {}).get("nome")) if isinstance(dbg.get("fields_v2"), dict) else None) or {}
        ...
        nat_dbg = (((dbg.get("fields_v2") or {}).get("naturalidade")) if isinstance(dbg.get("fields_v2"), dict) else None) or {}
    ...
    headers = ["file", "nome", "nome_method", "mrz_decision", "cidade", "uf", "nat_method", "parse_missing"]
